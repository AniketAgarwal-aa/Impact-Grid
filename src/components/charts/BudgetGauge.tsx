/** Semi-circle budget utilization gauge — works in both light and dark mode */
  ...
  return (
    <div>
      <div className="relative mx-auto" style={{ height, maxWidth: 280 }}>
        ...
        {/* Center text — uses CSS vars for theme-aware color */}
        <div
      ...
      {(usedAmount || remainingAmount || totalAmount) && (
        <div className="mt-2 grid grid-cols-3 gap-2 text-center text-xs">
          {usedAmount && (
            <div className="rounded-lg bg-accent/50 p-2 border border-border">
              <div className="font-semibold" style={{ color }}>{usedAmount}</div>
              <div className="text-muted-foreground">Used</div>
            </div>
          )}
          {remainingAmount && (
            <div className="rounded-lg bg-accent/50 p-2 border border-border">
              <div className="font-semibold text-emerald-500">{remainingAmount}</div>
